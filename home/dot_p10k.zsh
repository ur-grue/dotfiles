# ~/.p10k.zsh — Default-Config (offizielle Powerlevel10k 'lean'-Preset).
# Mitgeliefert, damit 'p10k configure' NICHT nötig ist. Eigene Anpassung
# jederzeit: 'p10k configure' neu ausführen oder Werte unten ändern.
# ---------------------------------------------------------------------------
